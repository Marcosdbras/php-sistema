...
class Financeiro extends CI_Controller {
	...
	public function lancamentos(){
		...
		$this->data['results'] = $this->financeiro_model->get('lancamentos','idLancamentos,descricao,valor,data_vencimento,data_pagamento,baixado,cliente_fornecedor,tipo,forma_pgto,iddetalhe',$where,$config['per_page'],$this->uri->segment(3));
	...
	function adicionarReceita() {
        ...
        if ($this->form_validation->run('receita') == false) {
            ...
            $data = array(
				...
				'data_pagamento' => $recebimento != null ? $recebimento : null,     //$recebimento != null ? $recebimento : date('Y-m-d'),
    ...
    function adicionarDespesa() {
        ...
        if ($this->form_validation->run('despesa') == false) {
            ...
            $data = array(
				...
				'valor' => $valor,                                 //set_value('valor'),
				'data_vencimento' => $vencimento,
				'data_pagamento' =>  $pagamento != null ? $pagamento : null,    //$pagamento != null ? $pagamento : date('Y-m-d'),
