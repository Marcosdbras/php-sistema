        ...
        <form action="<?php echo base_url(); ?>index.php/mapos/cadastrarEmitente" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal" >
            ...
            <div class="modal-body">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="rua2"  name="logradouro" value=""  />
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td> <span style="font-size: 20px; "> <?php echo $dados[0]->nome; ?> </span> </br><span><?php echo $dados[0]->cnpj; ?> </br> <?php echo $dados[0]->rua . ', nº:' . $dados[0]->numero . ', ' . $dados[0]->bairro . ' - ' . $dados[0]->cidade . ' - ' . $dados[0]->uf; ?> </span> </br> <span> E-mail: <?php echo $dados[0]->email . ' - Fone: ' . $dados[0]->telefone; ?></span><br />     
                                    <span> CEP: <?php echo $dados[0]->cep . ' - IBGE: ' . $dados[0]->ibge; ?></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <form action="<?php echo base_url(); ?>index.php/mapos/editarEmitente" id="formAlterar" enctype="multipart/form-data" method="post" class="form-horizontal" >
            ...
            <div class="modal-body">
                ...
                <div class="control-group">
                    <label for="descricao" class="control-label"><span class="required">Logradouro*</span></label>
                    <div class="controls">
                        <input  type="text"  id="rua"  name="logradouro" value="<?php echo $dados[0]->rua; ?>"  />
                    </div>
                </div>
                <div class="control-group">
                    <label for="descricao" class="control-label"><span class="required">Número*</span></label>
                ...
                <div class="control-group">
                    <label for="descricao" class="control-label"><span class="required">UF*</span></label>
                    <div class="controls">
                        <input type="text" id="uf"  name="uf" value="<?php echo $dados[0]->uf; ?>"  />
                    </div>
                </div>

                <div class="control-group">
                    <label for="descricao" class="control-label"><span class="required">IBGE*</span></label>
                    <div class="controls">
                        <input type="text" id="ibge"  name="ibge" value="<?php echo $dados[0]->ibge; ?>"  />
                    </div>
                </div>
