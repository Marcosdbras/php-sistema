    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            if($this->permission->checkPermission($this->session->userdata('permissao'),'dFornecedor')){
                echo '<a href="#modal-excluir" role="button" data-toggle="modal" cliente="'.$r->idFornecedores.'" style="margin-right: 1%" class="btn btn-danger tip-top" title="Excluir Fornecedor"><i class="icon-remove icon-white"></i></a>'; 
            }
