...
<html lang="en">
    ...
    <body>
                    ...
                    if (isset($menuRelatorios)) { echo 'active open';   }; ?>" >
                        ...
                        <ul>
                            ...
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFornecedor')) { ?>
                                <li><a href="<?php echo base_url() ?>index.php/relatorios/fornecedores">Fornecedores</a></li>
                            <?php } ?>                                
                            ...
                            <?php } ?>
                                <HR SIZE="2">
                                <h6><i class="icon icon-briefcase "></i>Movimento</h6>
                            ...
                            <?php } ?>
                                ...
                                <HR SIZE="2">
                                <h6><i class="icon icon-money "></i>Financeiro</h6>
                                
                                
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) { ?>
                                <li><a href="<?php echo base_url() ?>index.php/relatorios/financeiro">Contas</a></li>
                            <?php } ?>
        ...
        <!--Footer-part-->
        <div class="row-fluid">
            <div id="footer" class="span12"> 2017 &copy; MAP OS - Créditos: Marcos Brás / Ramon Silva</div>
        </div>
        <!--end-Footer-part-->
