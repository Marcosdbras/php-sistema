    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            if($this->permission->checkPermission($this->session->userdata('permissao'),'eComanda')){
                echo '<a style="margin-right: 1%" href="'.base_url().'index.php/comandas/editar/'.$r->idVendas.'" class="btn btn-info tip-top" title="Editar venda"><i class="icon-pencil icon-white"></i></a>'; 
            }
