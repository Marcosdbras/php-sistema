...
if( !$section_is_empty){ ?>
    <section class="team" id="team" role="region" aria-label="'<?php esc_attr_e( 'Team', 'azera-shop-companion' ); ?>" <?php echo ! empty( $azera_shop_our_team_background ) ? 'style="background:url(' . esc_url( $azera_shop_our_team_background ) . ');"' : ''; ?>>
                                ...
                                <div class="col-md-3 team-member-box">
                                    <div class="team-member border-bottom-hover">
                                        <div class="member-pic">
                                            <?php
                                            if ( ! empty( $image ) ) { ?>
                                                <img src="<?php echo esc_url( $image ); ?>" <?php echo( ! empty( $title ) ? 'alt="' . esc_attr( $title ) . '"' : esc_html__( 'Avatar', 'azera-shop-companion' ) ); ?>>
                                                <?php
                                            } else {
                                                $default_url = azera_shop_get_file( '/images/team/default.png' ); ?>
                                                <img src="<?php echo esc_url( $default_url ); ?>" alt="<?php esc_attr_e( 'Avatar', 'azera-shop-companion' ); ?>">
                                                <?php
                                            } ?>
                                        </div><!-- .member-pic -->
