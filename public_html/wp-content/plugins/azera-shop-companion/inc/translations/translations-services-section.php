...
function azera_shop_companion_sevices_get_default_content() {
	return json_encode( array(
			array(
				...
				'icon_value' => 'fa-cogs',
				'title'      => esc_html__( 'Lorem Ipsum', 'azera-shop-companion' ),
				'text'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus feugiat, molestie ipsum et, consequat nibh. Etiam non elit dui. Nullam vel eros sit amet arcu vestibulum accumsan in in leo.', 'azera-shop-companion' )
			),
